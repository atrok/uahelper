SELECT distinct CASE
 ...
 END AS application_type, apptype_id , release, OS, os_type FROM (
...
JOIN (SELECT a.dbid,a.name, a.os_version, a.os_type, b.lc_value AS os,a.ip_address,  a.lca_port,a.scs_dbid,a.state FROM cfg_host a JOIN cfg_locale b ON a.os_type=b.lc_subtype WHERE b.lc_type=11) d ON c.host_dbid=d.dbid
WHERE b.lc_type=6
) a
left JOIN (
...
JOIN cfg_switch c ON b.subsection1=cast(c.dbid as varchar)
